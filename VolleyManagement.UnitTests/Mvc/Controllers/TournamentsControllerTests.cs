namespace VolleyManagement.UnitTests.Mvc.Controllers
{
    ...
    public class TournamentsControllerTests
    {
        ...
        public void Index_TournamentsExist_TournamentsReturned()
        {
            ...
            // Act
            var actual = AssertExtensions.GetModel<IEnumerable<Tournament>>(sut.Index());
        ...
        public void Details_TournamentExists_TournamentIsReturned()
        {
            ...
            // Act
            var actual = AssertExtensions.GetModel<Tournament>(controller.Details(searchId));
        ...
        public void DeleteGetAction_Tournament_ReturnsToTheView()
        {
            ...
            // Act
            var actual = AssertExtensions.GetModel<Tournament>(controller.Delete(tournament.Id));
        ...
        public void Create_GetView_ReturnsViewWithDefaultData()
        {
            ...
            // Act
            var actual = AssertExtensions.GetModel<TournamentViewModel>(controller.Create());
        ...
        public void CreatePostAction_InvalidTournamentViewModel_ReturnsViewModelToView()
        {
            ...
            // Act
            var actual = AssertExtensions.GetModel<TournamentViewModel>(controller.Create(tournamentViewModel));
        ...
        public void EditGetAction_TournamentViewModel_ReturnsToTheView()
        {
            ...
            // Act
            var actual = AssertExtensions.GetModel<TournamentViewModel>(controller.Edit(tournament.Id));
        ...
        public void EditPostAction_InvalidTournamentViewModel_ReturnsViewModelToView()
        {
            ...
            // Act
            var actual = AssertExtensions.GetModel<TournamentViewModel>(controller.Edit(tournamentViewModel));
