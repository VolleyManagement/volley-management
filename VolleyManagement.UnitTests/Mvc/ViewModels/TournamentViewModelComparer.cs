namespace VolleyManagement.UnitTests.Mvc.ViewModels
{
    ...
    internal static class TournamentViewModelComparer
    {
        public static void AssertAreEqual(TournamentViewModel expected, TournamentViewModel actual)
        {
            ...
            Assert.AreEqual(expected.ApplyingPeriodEnd.Date, actual.ApplyingPeriodEnd.Date, $"[Id:{expected.Id}]ApplyingPeriodEnd should be equal.");
            Assert.AreEqual(expected.ApplyingPeriodStart.Date, actual.ApplyingPeriodStart.Date, $"[Id:{expected.Id}]ApplyingPeriodStart should be equal.");
