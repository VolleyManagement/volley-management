namespace VolleyManagement.UnitTests.Services.GameService
{
    ...
    public static class ExpectedExceptionMessages
    {
        ...
        public const string GAME_REQUIRED_SET_SCORES =
            "In the set, the number of points for one team must be at least 25" +
            " and the points difference should be at least 2. If the score exceeds 25," +
            " the points difference must be equal to 2. In case of a technical defeat" +
            " score of an optional game should be 25: 0 or 0: 25";

        public const string GAME_PREVIOUS_OPTIONAL_SET_UNPLAYED =
        "Enter a score of the previous optional game";

        public const string CONCURRENCY_EXCEPTION =
        "Optimistic concurrency check failed. Entity has been changed.";
    }
}