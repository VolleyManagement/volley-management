namespace VolleyManagement.UnitTests.Services.TournamentService
{
    ...
    public class TournamentServiceTests
    {
        ...
        private readonly Mock<IQuery<TournamentDto, TournamentDtoCriteria>> getTournamentDtoQuery =
        ...
        public void TestInit()
        {
            ...
            _kernel.Bind<IQuery<TournamentDto, TournamentDtoCriteria>>().ToConstant(getTournamentDtoQuery.Object);
