namespace VolleyManagement.UnitTests.WebApi.Controllers
{
    ...
    public class TournamentControllerTests
    {
        ...
        public void Get_SpecificTournamentExist_TournamentReturned()
        {
            ...
            // Act
            var response = tournamentsController.GetTournament(tournament.Id);
            var result = TestExtensions.GetModelFromSingleResult<TournamentViewModel>(response);
        ...
        {
            _tournamentServiceMock.Setup(tr => tr.Get()).Returns(testData.AsQueryable());
        }
