...
namespace VolleyManagement.UI.Areas.Mvc.ViewModels.GameResults
{
	...
	public class GameResultViewModel
	{
		...
		/// </summary>
		public GameResultViewModel(int setsCount)
		{
			GameScore = new ScoreViewModel();
			SetScores = Enumerable.Repeat(new ScoreViewModel(), setsCount).ToList();
		}
		...
		{
			var result = new GameResultViewModel(gameResult.ScoreScheme == ScoreSchemeEnum.BestOf3 ? 3 : 5)
			{
				Id = gameResult.Id,
