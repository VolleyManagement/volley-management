...
namespace VolleyManagement.UI.Areas.Mvc.ViewModels.Tournaments
{
	...
	public class TournamentViewModel
	{
		...
		public IList<string> ScoreSchemeList { get; set; }
		...
		[Display(Name = "ScoreScheme", ResourceType = typeof(ViewModelResources))]
		[Required(ErrorMessageResourceName = "FieldRequired", ErrorMessageResourceType = typeof(ViewModelResources))]
		...
		public static TournamentViewModel Map(Tournament tournament)
		{
			var tournamentViewModel = new TournamentViewModel
			{
				...
				ScoreScheme = tournament.ScoreScheme,
		...
		private void InitScoreSchemeList()
		{
			ScoreSchemeList = new List<string>
			{
				ScoreSchemeEnum.BestOf5.ToString(),
				ScoreSchemeEnum.BestOf3.ToString()
			};
		}
	}
}