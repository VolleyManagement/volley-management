...
{
	[Obsolete]
    public class AzureStorageUserRepositoryOld : AzureTableConnection, IUserRepositoryOld
    {
        private readonly IdentityContextTableStorageOptions _options;
        private readonly UserFactory _userFactory;
        private readonly IMapper _mapper;

        public AzureStorageUserRepositoryOld(IdentityContextTableStorageOptions options, UserFactory userFactory, IMapper mapper)
            : base(options)
        {
            _options = options;
