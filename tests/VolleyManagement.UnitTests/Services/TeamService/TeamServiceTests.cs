namespace VolleyManagement.UnitTests.Services.TeamService
{
    ...
    public class TeamServiceTests
    {
        ...
        {
            // Arrange
            MockGetPlayerByIdQuery(new PlayerBuilder().WithId(SPECIFIC_PLAYER_ID).Build());
        ...
        //    // Assert
        //    Assert.IsTrue(gotException);
        //    VerifyEditPlayer(UNASSIGNED_ID, Times.Never());
        //}
        ...
        //    // Assert
        //    Assert.IsTrue(gotException);
        //    VerifyEditPlayer(SPECIFIC_PLAYER_ID, Times.Never());
        //}
        ...
        //    // Assert
        //    VerifyEditPlayer(SPECIFIC_PLAYER_ID, Times.Once());
        //}
        ...
        //{
        //    // Arrange
        //    var firstPlayer = new PlayerBuilder().WithId(PLAYER_ID).Build();
        //    var secondPlayer = new PlayerBuilder().WithId(PLAYER_ID + 1).WithFirstName("Second").Build();
        //    var testRoster = new List<Player> { firstPlayer, secondPlayer };
        //    MockGetTeamRosterQuery(testRoster);

        //    var player = new PlayerBuilder().WithId(SPECIFIC_PLAYER_ID).Build();
        ...
        //    // Assert
        //    VerifyEditPlayer(SPECIFIC_PLAYER_ID, Times.Exactly(2));
        //}
        ...
        //    var testPlayer = new PlayerBuilder().WithId(PLAYER_ID).Build();
        //    var testSecondPlayer = new PlayerBuilder().WithId(PLAYER_ID + 1).Build();
        //    var testRoster = new List<Player> { testPlayer, testSecondPlayer };
        //    MockGetTeamRosterQuery(testRoster);

        //    var player = new PlayerBuilder().WithId(SPECIFIC_PLAYER_ID + 1).Build();
        //    var roster = new List<Player> { player };
        ...
        private void VerifyEditPlayer(int playerId, Times times)
        {
